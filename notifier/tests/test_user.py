...
class RoleTestCase(TestCase):
    ...
    def test_get_digest_moderators_flagged(self):
        """
    ...
    @override_settings(US_URL_BASE="test_server_url", US_RESULT_PAGE_SIZE=3)
    def test_get_digest_moderators_single_page_flagged(self):
        """
    ...
    def test_get_digest_moderators_basic_auth_flagged(self):
        """
    ...
    @override_settings(US_URL_BASE="test_server_url", US_RESULT_PAGE_SIZE=3)
    def test_get_digest_moderators_multi_page_flagged(self):
        """
